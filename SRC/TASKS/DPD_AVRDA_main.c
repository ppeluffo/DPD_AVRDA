 ...
 * - Arreglos en formato de datos presentados
 * - Hago modulo de test para probar funcionalidades
 *   TEST0: solo lee el ADC.
 *   TEST1: idem pero muestra el valor de c/sample del adc
 *   TEST2: idem1 pero prende y apaga el led en c/sample
 * 
 * -----------------------------------------------------------------------------
