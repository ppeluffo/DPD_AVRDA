...
#define OPEN_VALVE0()  ( VALVE0_CTRL_PORT.OUT |= VALVE0_CTRL_PIN_bm ); vstatus.vs0 = VALVE_OPEN;
#define CLOSE_VALVE0() ( VALVE0_CTRL_PORT.OUT &= ~VALVE0_CTRL_PIN_bm ); vstatus.vs0 = VALVE_CLOSE;
